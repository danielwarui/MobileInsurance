...
public class Inspection_Report extends Activity implements OnClickListener {
		...
		next.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if (photo == null) {
					...
					saveImage("INSPECTION_REPORT", ba1);
					Inspection_Report.this.finish();
					startActivity(new Intent(getApplicationContext(),
							Notice_Prosecution.class));
				}
			}
		});
	}
