...
public class Police_Abstract extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.police_abstract);
		...
		next.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if (photo == null) {
					...
					saveImage("POLICE_ABSTRACT", ba1);
					Police_Abstract.this.finish();
					startActivity(new Intent(getApplicationContext(),
							Inspection_Report.class));
				}
			}
		});
	}
